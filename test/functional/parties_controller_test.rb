...
class PartiesControllerTest < ActionController::TestCase
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post :create, party: { approved: @party.approved, description: @party.description, name: @party.name }
    end
  ...
  test "should update party" do
    put :update, id: @party, party: { approved: @party.approved, description: @party.description, name: @party.name }
    assert_redirected_to party_path(assigns(:party))
  end
